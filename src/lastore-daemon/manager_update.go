...
func (m *Manager) generateUpdateInfo(platFormPackageList map[string]system.UpgradeInfo) (error, error) {
	...
	var systemPackageList []string
	var securityPackageList []string
	...
	if systemErr == nil && systemPackageList != nil {
		propPkgMap[system.SystemUpdate.JobType()] = systemPackageList
	}
	if securityErr == nil && securityPackageList != nil {
		propPkgMap[system.SecurityUpdate.JobType()] = securityPackageList
	}
...
func getSecurityUpdatePackageList() ([]string, error) {
...
func listDistUpgradePackages(updateType system.UpdateType) ([]string, error) {
	...
	return apt.ListDistUpgradePackages(sourcePath)
}
