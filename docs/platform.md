...
| 事件名称 | 变量 | API | 公网 | 内网|
|----|----|---- | ----| ----|
|检查更新前 | preUpdateCheck | /api/v1/process | ✗ | ✔ |
|检查更新后|postUpdateCheck  | /api/v1/process | ✗ | ✔ |
|下载更新前|preDownloadCheck | /api/v1/process | ✗ | ✔ |
|下载更新后|postDownloadCheck| /api/v1/process | ✗ | ✔ |
|备份前|preBackupCheck       | /api/v1/process | ✗ | ✔ |
|备份后|postBackupCheck       | /api/v1/process | ✗ | ✔ |
|系统升级前|preCheck          | /api/v1/process | ✗ | ✔ |
|系统升级后|midCheck          |  /api/v1/process | ✗ | ✔ |
|系统升级完成重启后|postCheck  |  /api/v1/process | ✗ | ✔ |
